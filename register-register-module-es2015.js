...
/* harmony import */ var src_app_model_expense__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! src/app/model/expense */ "./src/app/model/expense.ts");
...
let RegisterComponent = class RegisterComponent {
    ...
    doRegister() {
        ...
        email && password && this.fireAuth.createUserWithEmailAndPassword(email, password).then(response => {
            return response !== null ? this.router.navigateByUrl(src_app_model_expense__WEBPACK_IMPORTED_MODULE_5__["AppRoutes"].LOGIN) : false;
        });
    }
...
RegisterModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [
            ...
            _angular_router__WEBPACK_IMPORTED_MODULE_5__["RouterModule"].forChild([{ path: '', component: _register_component__WEBPACK_IMPORTED_MODULE_4__["RegisterComponent"] }])
        ]
    })
], RegisterModule);
