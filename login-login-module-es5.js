(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["login-login-module"], {
    ...
    function srcAppAuthLoginLoginComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _model_expense__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../../model/expense */
      ...
      var LoginComponent = /*#__PURE__*/function () {
        function LoginComponent(router, authService, userService) {
          ...
          _capacitor_core__WEBPACK_IMPORTED_MODULE_3__["Plugins"].Device.getInfo().then(function (deviceInfo) {
            if (deviceInfo.platform !== 'web') {
              _capacitor_core__WEBPACK_IMPORTED_MODULE_3__["Plugins"].Keyboard.setResizeMode({
                mode: _capacitor_core__WEBPACK_IMPORTED_MODULE_3__["KeyboardResize"].None
              });

              _capacitor_core__WEBPACK_IMPORTED_MODULE_3__["Plugins"].Keyboard.addListener('keyboardWillShow', function () {
        ...
        _createClass(LoginComponent, [{
          ...
          value: function doLogin() {
            ...
            this.authService.loginWithEmailAndPassword(email, password).then(function (res) {
              _this.userService.setCurrentUser(res.user);

              _this.router.navigateByUrl(_model_expense__WEBPACK_IMPORTED_MODULE_5__["AppRoutes"].TABS);
            });
          }
        }, {
    ...
    function srcAppAuthLoginLoginModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      LoginModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_5__["IonicModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_6__["ReactiveFormsModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild([{
          path: '',
