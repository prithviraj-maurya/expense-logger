...
const routes = [
    {
        path: 'tabs',
        loadChildren: () => Promise.all(/*! import() | tabs-tabs-module */[__webpack_require__.e("default~forgot-password-forgot-password-module~tabs-tabs-module"), __webpack_require__.e("default~login-login-module~tabs-tabs-module"), __webpack_require__.e("tabs-tabs-module")]).then(__webpack_require__.bind(null, /*! ./tabs/tabs.module */ "./src/app/tabs/tabs.module.ts")).then(m => m.TabsPageModule)
    },
    {
        path: 'auth',
...
module.exports = __webpack_require__(/*! D:\Prithvi\Ionic\expense-logger\src\main.ts */"./src/main.ts");
