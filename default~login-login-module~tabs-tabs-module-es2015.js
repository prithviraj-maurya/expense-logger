...
let AuthService = class AuthService {
    ...
    registerWithEmailAndPassword(email, password) {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            if (email && password) {
                return yield this.fireAuth.createUserWithEmailAndPassword(email, password);
            }
        });
    }
    // Logout
    logout() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return yield this.fireAuth.signOut();
        });
    }
};
...
let StorageService = class StorageService {
    ...
    clearStorage() {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function* () {
            return yield _capacitor_core__WEBPACK_IMPORTED_MODULE_2__["Plugins"].Storage.clear();
        });
    }
};
...
/* harmony import */ var src_app_model_expense__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! src/app/model/expense */ "./src/app/model/expense.ts");
...
let UserService = class UserService {
    constructor(storageService) {
        ...
        this.currentUserObservable = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"](null);
    }
    getCurrentUser() {
    ...
    setCurrentUser(user) {
        ...
        this.storageService.setObject(src_app_model_expense__WEBPACK_IMPORTED_MODULE_3__["StorageKeys"].ACTIVE_USER, user);
